...
//dprintf("post-trans: %f, post-engine: %f\n",transrevs,engine->revs);
	...
	static float fvalues[5]={0,1,1500,4000,6000}; // the higher the value, the higher the friction
...
#define WANGLE(a)	(engine->localVelocity.z  * wheel[a]->oneoverradius)
		...
		FwheelShadowObjectLEFT->setAngle( &(a + vector3( WANGLE(0), 0, 0 ) ));

		getWheelAngle(1, &a );
		a.y = turnY;
		setWheelAngle(1, &(a + vector3( WANGLE(1), 0, 0 ) ) );
		FwheelShadowObjectRIGHT->setAngle( &(a + vector3( WANGLE(1), 0, 0 ) ));
